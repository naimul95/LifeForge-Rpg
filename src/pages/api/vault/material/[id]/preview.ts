...
export default async function preview(request: NextApiRequest, response: NextApiResponse) {
  ...
  try {
    ...
    if (!upstream.ok) { response.status(502).end("Preview unavailable."); return; }
